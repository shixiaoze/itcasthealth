...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_205810681";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "传智健康S";// 短信的签名
	...
	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"12345678900","666666");
	}
