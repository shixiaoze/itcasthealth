...
/**
 * 包名： com.zxs.health.Utils
 *
 * @author: shixiaoze
 * 日期: 2020/11/23 18:53
 */
public class QiNiuUtils {
    private static final String ACCESSKEY = "YYvMtwt9tjUgpgBcPpZsV3WJ3sWOV15jYrw-SClr";
    private static final String SECRETKEY = "LsnGq60ADoPgWt-bj1Q-jFnpjfUIXcoJx6loMazQ";
    private static final String BUCKET = "sxz-health";
    public static final String DOMAIN= "http://qk8p2uwoc.hd-bkt.clouddn.com/";
